...
import 'package:iot_eni/notification.dart';
  ...
  runApp(
    MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        NotificationPage.routeName: (_) => NotificationPage(notificationAppLaunchDetails),
            ...
            children: [
              Padding(
                ...
                child: Material(
                  ...
                  elevation: 2,
                  child: Container(
                    child: Center(child: Text("38°C", style: TextStyle(fontSize: 50.0),)),
                    height: 150,
                  ),
                ),
              ),
...
//                          title: Icon(Icons.warning, size: 70.0, color: Colors.amber,),
//                          content: Text("Voulez vous arreter le système ?"),
//                          actions: [
//                            FlatButton(onPressed: null, child: Text("Confirmer")),
//                            FlatButton(onPressed: null, child: Text("Annuler")),
//                          ],
//                        ));
//                      },
//                      child: ListTile(
//                        leading: const Icon(Icons.logout),
//                        title: Text("Arreter le système"),
//                      ),
//                    ),
                    SwitchListTile(
                      title: const Text('Arret système'),
                      value: _systeme,
                      onChanged: (bool value) {
                        setState(() {
                          _systeme = value;
